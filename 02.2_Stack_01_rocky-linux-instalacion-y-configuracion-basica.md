...
*   **Infraestructura:** Ejecutar en contenedores LXC, máquinas virtuales o instancias en la nube efímeras.
...
*   **Usuarios:** No crear usuarios durante la instalación. La gestión de usuarios se hará a través del dominio centralizado.
...
*   **Gobernanza:** Todo cambio en TEST debe provenir de una promoción formal desde DEV, documentada y aprobada mediante un checklist de calidad.
...
*   **Usuarios:** No crear ningún usuario durante la instalación. Toda la gestión de identidad será externa.
...
---
**Fuente:** Esta guía se basa en las mejores prácticas de seguridad y administración de sistemas para RHEL/Rocky Linux, tal como se describe en las obras de Smyth (2023) sobre Rocky Linux 9 y Red Hat Enterprise Linux 9, y en guías de implementación práctica como las de Fanta (2025) sobre FreeIPA en RHEL 10, adaptadas a los requisitos de un entorno de fábrica de software moderno y al ciclo de vida de Rocky Linux 10.
